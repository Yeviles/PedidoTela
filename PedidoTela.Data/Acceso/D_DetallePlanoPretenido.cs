...
namespace PedidoTela.Data.Acceso
{
    public class D_DetallePlanoPretenido
    {
        ...
        private readonly string actualizar = "UPDATE cfc_spt_sol_plano_pretenido_detalle SET codigo_vte=?, descripcion_vte=?, codigo_h1=?, descripcion_h1=?,codigo_h2=?, descripcion_h2=?, codigo_h3=?, descripcion_h3=?, codigo_h4=?, descripcion_h4=?, codigo_h5=?, descripcion_h5=?, tiendas=?, exito=?, cencosud=?, sao=?, comercio=?, rosado=?, otros=?, total=? WHERE id = ?;";

        private readonly string consultaId = "select id from cfc_spt_sol_plano_pretenido_detalle where idplano = ?;";
        #endregion
        ...
        public string Actualizar(DetallePlanoPretenido elemento, int idDetalle)
        {
            string respuesta = "";
            try
            {
        ...
        public List<int> ConsultarId(int idPlano)
        {
            int id = 0;
